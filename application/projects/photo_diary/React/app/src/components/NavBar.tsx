...
const NavBar: React.FC = () => {
    ...
    return (
        <main className={useMediaQueries(classBase)}>
            ...
            <nav className={useMediaQueries(classBase.concat('_menu'))}>
                <ul id="Navbar_menu_list">

                    <li id="Navbar_menu_list_item_about" onClick={handleMenuItemClicks}>
                        <a href="#"
                            className={useMediaQueries(classBase.concat('_menu_list_name'))}>
                                about</a>
                ...
                <div className={useMediaQueries(classBase.concat('_menu_toggle'))}>
